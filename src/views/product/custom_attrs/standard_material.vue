<template>
  ...
  <div>
    ...
    <div class="item-margin">
      <div class="item-cont">
        <el-button size="small" type="primary" @click="addMaterial">新增原料</el-button>
      </div>
      <!-- table订单 -->
      <div class="item-table">
        ...
        >
          ...
          <el-table-column prop="code" label="标准编码" align="center" min-width="100"></el-table-column>
          <el-table-column prop="materialFullCateName" label="属性分类" align="center" min-width="100"></el-table-column>
          <el-table-column prop="name" label="原料名称" align="center" min-width="100"></el-table-column>
          <el-table-column prop="unitPrice" label="销售价格" align="center" min-width="100"></el-table-column>
          <el-table-column prop="image" label="原料图片" align="center" min-width="100">
            <template slot-scope="scope">
              <img class="table-img-wh" :src="scope.row.image">
            </template>
          </el-table-column>
          <el-table-column prop="valid" label="使用状态" align="center" min-width="70">
            <template slot-scope="scope">
              <el-switch
...
export default {
  ...
  methods: {
    ...
    addMaterial() {
      this.$router.push({
        path: "/product/custom_attrs/add_material",
        name: "add_material",
        query: {
          _type: "add"
        }
    ...
    openShowDetails(params) {
      this.$router.push({
        path: "/product/custom_attrs/show_material",
        name: "show_material",
        query: {
          _id: params.id,
          _type: "show"
    ...
    openEditDetails(params) {
      this.$router.push({
        path: "/product/custom_attrs/edit_material",
        name: "edit_material",
        query: {
          _id: params.id,
          _type: "edit"
