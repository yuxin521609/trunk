 ...
 * @LastEditTime: 2019-08-13 14:39:12
    ...
    >
      <el-row>
        <el-tabs v-model="activeName" class="basic-wrap">
          <el-tab-pane label="基本信息" name="basic">
            <el-col :span="24">
              <div class="flex-cen-start">
                <el-form-item prop="name" label="制造商名称：">
                  <el-input
                    class="input-w-2"
              ...
              <div class="flex-cen-start">
                <el-form-item prop="address" label="制造商地址：">
                  <el-input
                    class="input-w-2"
                    :disabled="showDisabled"
                    placeholder="请输入内容"
          ...
          <el-tab-pane label="制造商资质" name="brand_qcation">
            <el-col :span="24">
...
export default {
  ...
  methods: {
    ...
    arrHandleRemove(file, fileList) {
      ...
      let imgArr = this.filtersData.manufacturerProfiles;
    ...
    arrHandleAvatarSuccess(res, file) {
      ...
      let obj = new Object();
      obj.enterpriseType = 4; //1品牌 2 供应商 3设计商 4制造商
      obj.type = 1; //资质 1  协议2
      obj.path = res.data.imageUrl;
      obj.enterpriseName = "";
      this.filtersData.manufacturerProfiles.push(obj);
      // console.log( this.filtersData.manufacturerProfiles);
    }, //协议
    ...
    //获取数据
    getData() {
       this.request(this.api.product.manufacturer_get, { id: this._id }).then(data => {
        let _data = data;
        let _Profiles = _data.manufacturerProfiles;
        this.filtersData = _data; //manufacturerProfiles
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          _data.manufacturerProfiles.forEach((item, index) => {
            item.enterpriseName = _name;
          });
            this.request(this.api.product.manufacturer_save, this.filtersData).then(data => {
