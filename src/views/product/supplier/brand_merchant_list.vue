 ...
 * @Description: 品牌商 列表
 * @Author:elephant
 * @Date: 2019-08-13 13:57:23
 * @LastEditTime: 2020-02-25 15:22:48
...
<template>
  <div>
    ...
    <div class="item-margin">
      <div class="item-cont">
        <el-button-group>
          <el-button size="small" type="primary" @click="openAddAttrbute">新增品牌商</el-button>
        </el-button-group>
      </div>
      <div class="item-table">
        ...
        >
          <el-table-column prop="code" align="center" label="品牌商编码" min-width="100"></el-table-column>
          <el-table-column prop="name" align="center" label="品牌商名称" min-width="100"></el-table-column>
          <el-table-column prop="contact" align="center" label="联系人" min-width="100"></el-table-column>
          <el-table-column prop="telephone" align="center" label="联系电话" min-width="100"></el-table-column>
          <el-table-column prop="address" align="center" label="品牌商地址" min-width="100"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    openAddAttrbute() {
      this.$router.push({
        path: "/product/supplier/add_brand_merchant",
        query: {
          type: "add"
        }
      });
    ...
    openShowDetails(id) {
      this.$router.push({
        path: "/product/supplier/show_brand_merchant",
        query: {
          id: id,
          type: "show"
        }
    ...
    openEditDetails(id) {
      this.$router.push({
        path: "/product/supplier/edit_brand_merchant",
        query: {
          id: id,
          type: "edit"
        }
    ...
    //滑块开关
    switchValid(params) {
      this.request(this.api.product.productBrandOwner_save, params).then(
        res => {
