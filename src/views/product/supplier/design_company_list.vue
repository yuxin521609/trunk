<template>
    ...
    <div class="item-cont">
      <el-button-group>
        <el-button size="small" type="primary" @click="openAddAttrbute">新增设计商</el-button>
      </el-button-group>
    </div>
    <div class="item-table">
      ...
      >
        <el-table-column prop="code" align="center" label="设计商编码" width="100"></el-table-column>
        <el-table-column prop="name" align="center" label="设计商名称" min-width="100"></el-table-column>
         ...
         <el-table-column prop="address" align="center" label="设计商地址" min-width="100"></el-table-column>
...
export default {
  name:'design_company_list',
    ...
    methods:{
      //获取列表
        getTableList(){
            this.request(this.api.product.designCompany_list, this.filtersData).then(data => {
        ...
        openAddAttrbute(){
            this.$router.push({
                path:'/product/designCompany/add_design_company',
                 query: {
                  type:'add'
                }
            })
        ...
        openShowDetails(params){
          this.$router.push({
            path:'/product/designCompany/show_design_company',
            query: {
              id:params,
              type:'show'
            }
        ...
        openEditDetails(params){
          this.$router.push({
            path:'/product/designCompany/edit_design_company',
            query: {
              id:params,
              type:'edit'
            }
        ...
        handleSizeChange(val) {
         ...
         //滑块开关
        switchValid(params){
            this.request(this.api.product.designCompany_save, params)
            .then(data => {
