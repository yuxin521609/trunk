    ...
    <div>
        ...
        <div class="item-margin">
            ...
            <div class="item-table">
                ...
                >
                    <el-table-column prop="type" align="center" label="消息编码" min-width="100"></el-table-column>
                    <el-table-column prop="type" align="center" label="消息类型" min-width="100">
                        <template slot-scope="scope">{{"CEN015"|codeToName(scope.row.type)}}</template>
                    </el-table-column>
                    ...
                    <el-table-column prop="updateTime" align="center" label="更新时间" min-width="100">
        ...
        <tp-class-details :itemParam="itemStautsParam" @refreshItem="refreshList"
                          ref="messageTemplateDetailsCpt"></tp-class-details>
    </div>
</template>
<script>
    /**
     * 模板管理
     */
    import messageTemplateDetailsAy from "@/views/system/messageTemplate_details.vue";
    ...
    export default {
        ...
        components: {
            codeSet,
            [messageTemplateDetailsAy.name]: messageTemplateDetailsAy
        },
        data() {
            return {
                filtersData: {
        ...
        methods: {
            ...
            //滑块开关
            switchValid(params) {
                this.request(this.api.system.messageTemplate_save, params).then(data => {
                    this.$message({
                        type: "success",
            ...
            openAddClass() {
                this.itemStautsParam.type = 'add',
                    this.itemStautsParam.title = "新增消息模板"
                this.$refs.messageTemplateDetailsCpt.messageTemplateDetailsPopupInit();
            },
            //查看  //查看 及修改 只带ID过去取消传参
            handleShowClick(_id) {
                this.itemStautsParam.type = 'show';
                this.itemStautsParam.title = "查看消息模板";
            ...
            handleEditClick(_id) {
                ...
                this.itemStautsParam.title = "修改消息模板";
                this.itemStautsParam.id = _id;
                this.$refs.messageTemplateDetailsCpt.messageTemplateDetailsPopupInit();
            },
            //删除模板
