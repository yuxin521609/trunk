      ...
      <div class="item-margin">
         <el-form
            ...
            <el-form-item label="模糊查询：">
                  <el-input v-model="filtersData.filter" @keyup.enter.native="handleSearch" placeholder="工单号/工单名称"></el-input>
            </el-form-item>
            <!-- 业务类型 -->
            ...
            <el-table
               ...
               <el-table-column
                  ...
                  <template slot-scope="scope">
                     ...
                     <el-button type="text" @click="dispose(scope.row)" size="small">处理</el-button>
                     <el-button type="text" @click="waitWorkOrderRelease(scope.row)" size="small">释放</el-button>
                     <br/>
                     <el-button type="text" @click="followUp(scope.row)" size="small">跟进</el-button>
...
export default {
   ...
   methods: {
      ...
      fnDialogTableVisible() {
         this.waitWorkOrderAssign(this.ls);
