   ...
   <div>
      ...
      <div class="item-margin">
         <el-form
            ...
            <el-form-item label="模糊查询：">
               <el-input v-model="filtersData.name" @keyup.enter.native="handleSearch" placeholder="工单名称"></el-input>
            </el-form-item>
            <el-form-item label="业务类型：">
               <code-set v-model="filtersData.busType" code="CEN012" :multiple="false"/>
            </el-form-item>
            <el-form-item label="适用部门：">
               <tree-dept
                  v-model="filtersData.dept"
                  val-type="id"
                  :sel-type="1"
      ...
      <div class="item-margin">
         <div class="item-table">
            <el-button size="small" type="primary" class="ml-20 mt-24" @click="href('workorder/config/workOrder_add')">新增</el-button>
            <el-table
                class="mt-20"
...
export default {  
   ...
   methods: {
       ...
       */
      timeRedact(item) {
         this.href('workorder/config/workOrder_redact',{
            id:item.id
         })
      },
      // 点击页数
